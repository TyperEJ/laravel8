...
curl -X GET \
    ...
    -d '{"first_name":"repellendus","middle_name":"ea","last_name":"vero","suffix":17,"preferred_name":"et","used_any_other_names":false,"former_first_name":"ex","former_middle_name":"dolores","former_last_name":"quas","sex":false,"sex_descr":"magni","birth_date":"exercitationem","address":[{"county":"reiciendis","country_code":7,"country_value":"dicta","address_line_1":"alias","address_line_2":"ad","address_line_3":"id","city":"natus","state":20,"state_value":"magni","zip":"quis"}],"used_mailing_address":false,"mailing_address":[{"county":"voluptatum","country_code":9,"country_value":"enim","address_line_1":"eius","address_line_2":"nulla","address_line_3":"autem","city":"porro","state":11,"state_value":"reiciendis","zip":"voluptatibus"}],"is_temporary_mailing_address":true,"temporary_mailing_address_from_date":"veritatis","temporary_mailing_address_to_date":"earum","preferred_phone":true,"preferred_phone_number":[{"country_code":"accusantium","phone_number":"et","extension":"qui"}],"used_alternate_phone":true,"alternate_phone_number":[{"country_code":"laborum","phone_number":"ut","extension":"non"}],"religion":4,"religion_descr":"laudantium","us_armed_forces_status":6,"us_military_anticipated_status":5,"us_military_experiences":[{"branch":2,"from_month":"minima","to_month":"nemo"}],"ever_received_discharge":true,"discharge_descr":"autem","is_hispanic_or_latino":true,"hispanic_or_latino_identities":[],"hispanic_or_latino_descr":"vitae","other_identities":[],"tribal_identity":"repellendus","is_federally_recognized_tribe":false,"tribe":20,"tribal_enrollment_number":"aut","asian_backgrounds":[],"east_asian_descr":"facilis","south_asian_descr":"harum","southeast_asian_descr":"rerum","african_american_backgrounds":[],"african_american_descr":"veritatis","native_hawaiian_or_other_pacific_islander_backgrounds":[],"native_hawaiian_or_other_pacific_islander_descr":"blanditiis","white_backgrounds":[],"white_descr":[],"agreed_terms_demographics":false,"birth_country":10,"birth_city":"animi","birth_state":3,"lived_in_us_yr":13,"lived_outside_us_yr":7,"languages":[{"lang":6,"proficiency":[]}],"citizenship_status":2,"ssn_number":"voluptatibus","list_citizenship":[],"green_card_file":"quis","arn_number":"est","arn_expiration_date":"architecto","hold_us_visa":false,"held_visa":13,"visa_number":"praesentium","visa_date_issued":"eveniet","other_visa_type_descr":"odit","want_to_apply_us_visa":14,"want_to_apply_other_visa_descr":"nulla","apply_fee_waiver":false,"fee_waiver_indicators":[],"fee_waiver_signature":"culpa","want_info_from_strive_for_college":true,"parents_marital_status":3,"divorced_yr":"qui","want_to_list_step_parents":true,"step_parents_number":12,"whom_make_your_permanent_home":2,"living_situation_descr":"harum","has_children":false,"children_number":18,"parents":[{"type":2,"is_living":true,"deceased_date":"in","prefix":19,"first_name":"culpa","middle_name":"in","last_name":"delectus","former_last_name":"dolor","suffix":9,"birth_country":13,"occupation":2,"occupation_descr":"dolores","education_level":5,"colleges":[{"name":"corporis","ceeb_code":11,"school_type_code":"atque","city":"iusto","state":"dolorem","state_value":"neque","zip":"dolores","country_code":12,"country_value":"dolorem","address_line_1":"ratione","address_line_2":"ea","address_line_3":"molestias","degrees":[{"name":3,"received_yr":"quaerat"}]}]}],"prefix":20,"relationship":"ut","email":"et","address_type":17,"occupation":6,"occupation_descr":"eos","employment_status":1,"position":"dignissimos","is_employed_or_retired_college":true,"current_employer_name":"qui","college_employer":[{"name":"corporis","ceeb_code":12,"school_type_code":"minus","city":"voluptate","state":"voluptatem","state_value":"ut","zip":"quibusdam","country_code":3,"country_value":"sed","address_line_1":"odit","address_line_2":"consectetur","address_line_3":"explicabo"}],"education_level":17,"colleges":[{"name":"et","ceeb_code":1,"school_type_code":"beatae","city":"id","state":"quo","state_value":"a","zip":"eos","country_code":6,"country_value":"ducimus","address_line_1":"quisquam","address_line_2":"accusantium","address_line_3":"et","degrees":[{"name":1,"received_yr":"et"}],"course_details":1,"from_month":"qui","to_month":"nam","degree":7}],"siblings":[{"first_name":"sint","middle_name":"aperiam","last_name":"ducimus","age":14,"relationship":19,"education_level":17,"college":[{"name":"et","ceeb_code":13,"school_type_code":"molestiae","city":"labore","state":"eaque","state_value":"quo","zip":"voluptatem","country_code":2,"country_value":"quis","address_line_1":"itaque","address_line_2":"quis","address_line_3":"cum","degree":[{"name":7,"from_month":"assumenda","to_month":"ullam"}]}]}],"name":"numquam","ceeb_code":19,"school_type_code":"placeat","city":"et","state":"eveniet","state_value":"ut","zip":"iusto","country_code":1,"country_value":"quaerat","address_line_1":"odit","address_line_2":"sint","address_line_3":"rerum","entry_month":"debitis","is_boarding_high_school":true,"live_on_campus":true,"graduate_from_school":false,"high_school_exit_month":"accusantium","receive_high_school_equivalency":true,"receive_high_school_equivalency_month":"perspiciatis","high_school_descr":"tempora","progression":[],"progression_descr":"quam","other_high_schools":[{"name":"suscipit","ceeb_code":2,"school_type_code":"doloremque","city":"iste","state":"consequuntur","state_value":"eligendi","zip":"velit","country_code":19,"country_value":"quia","address_line_1":"enim","address_line_2":"in","address_line_3":"libero","from_month":"eum","to_month":"eum"}],"why_leave_other_high_school":"eos","graduating_class_size":19,"class_rank_reporting":2,"exact_class_rank":4,"decile_rank":4,"quintile_rank":11,"quartile_rank":19,"class_rank_weighting":11,"gpa_scale_reporting":10,"cumulative_gpa":9,"gpa_weighting":15,"courses_scheduling_system":"aperiam","courses":[{"title":"pariatur","level":11,"schedule":[]}],"honors":[{"title":"ducimus","level":[],"level_recognition":[]}],"community_based_organizations":[{"organization_name":10,"mentor_prefix":"fuga","mentor_first_name":"porro","mentor_last_name":"odio","mentor_email":"officiis","mentor_phone_number":[{"country_code":"numquam","phone_number":"ad","extension":"velit"}]}],"career_interest":9,"career_interest_descr":"reprehenderit","highest_degree_to_earn":15,"gave_leaving_exams":false,"tests":[{"type":13,"subject":14,"score":6,"taken_date":"et","future_sitting_months":[]}]}'
...
let body = {
    ...
    "former_first_name": "ex",
    "former_middle_name": "dolores",
    "former_last_name": "quas",
    "sex": false,
    "sex_descr": "magni",
    ...
    "mailing_address": [
        {
            ...
            "city": "porro",
            "state": 11,
            "state_value": "reiciendis",
            "zip": "voluptatibus"
        }
    ],
    "is_temporary_mailing_address": true,
    "temporary_mailing_address_from_date": "veritatis",
    "temporary_mailing_address_to_date": "earum",
    "preferred_phone": true,
    "preferred_phone_number": [
        {
            "country_code": "accusantium",
            "phone_number": "et",
            "extension": "qui"
        }
    ],
    ...
    "alternate_phone_number": [
        {
            "country_code": "laborum",
            "phone_number": "ut",
            "extension": "non"
        }
    ],
    "religion": 4,
    "religion_descr": "laudantium",
    "us_armed_forces_status": 6,
    "us_military_anticipated_status": 5,
    ...
    "hispanic_or_latino_descr": "vitae",
    "other_identities": [],
    "tribal_identity": "repellendus",
    ...
    "asian_backgrounds": [],
    "east_asian_descr": "facilis",
    "south_asian_descr": "harum",
    "southeast_asian_descr": "rerum",
    "african_american_backgrounds": [],
    "african_american_descr": "veritatis",
    "native_hawaiian_or_other_pacific_islander_backgrounds": [],
    "native_hawaiian_or_other_pacific_islander_descr": "blanditiis",
    "white_backgrounds": [],
    "white_descr": [],
    ...
    "ssn_number": "voluptatibus",
    "list_citizenship": [],
    "green_card_file": "quis",
    "arn_number": "est",
    "arn_expiration_date": "architecto",
    "hold_us_visa": false,
    "held_visa": 13,
    "visa_number": "praesentium",
    "visa_date_issued": "eveniet",
    "other_visa_type_descr": "odit",
    "want_to_apply_us_visa": 14,
    "want_to_apply_other_visa_descr": "nulla",
    "apply_fee_waiver": false,
    "fee_waiver_indicators": [],
    "fee_waiver_signature": "culpa",
    "want_info_from_strive_for_college": true,
    "parents_marital_status": 3,
    "divorced_yr": "qui",
    "want_to_list_step_parents": true,
    "step_parents_number": 12,
    "whom_make_your_permanent_home": 2,
    "living_situation_descr": "harum",
    "has_children": false,
    "children_number": 18,
    "parents": [
        {
            ...
            "colleges": [
                {
                    "name": "corporis",
                    "ceeb_code": 11,
                    "school_type_code": "atque",
                    "city": "iusto",
                    "state": "dolorem",
                    "state_value": "neque",
                    "zip": "dolores",
                    "country_code": 12,
                    "country_value": "dolorem",
                    "address_line_1": "ratione",
                    "address_line_2": "ea",
                    "address_line_3": "molestias",
                    "degrees": [
                        {
                            "name": 3,
                            "received_yr": "quaerat"
    ...
    "current_employer_name": "qui",
    "college_employer": [
        {
            "name": "corporis",
            "ceeb_code": 12,
            "school_type_code": "minus",
            "city": "voluptate",
            "state": "voluptatem",
            "state_value": "ut",
            "zip": "quibusdam",
            ...
            "country_value": "sed",
            "address_line_1": "odit",
            "address_line_2": "consectetur",
            "address_line_3": "explicabo"
        }
    ],
    "education_level": 17,
    "colleges": [
    ...
    "high_school_exit_month": "accusantium",
    "receive_high_school_equivalency": true,
    "receive_high_school_equivalency_month": "perspiciatis",
    "high_school_descr": "tempora",
    "progression": [],
    "progression_descr": "quam",
    "other_high_schools": [
        {
            "name": "suscipit",
            "ceeb_code": 2,
            "school_type_code": "doloremque",
            "city": "iste",
            "state": "consequuntur",
            ...
            "address_line_1": "enim",
            "address_line_2": "in",
            "address_line_3": "libero",
            "from_month": "eum",
            "to_month": "eum"
        }
    ],
    "why_leave_other_high_school": "eos",
    "graduating_class_size": 19,
    ...
    "community_based_organizations": [
        {
            ...
            "mentor_prefix": "fuga",
            "mentor_first_name": "porro",
            "mentor_last_name": "odio",
            "mentor_email": "officiis",
            "mentor_phone_number": [
                {
    ...
    "career_interest": 9,
    "career_interest_descr": "reprehenderit",
    "highest_degree_to_earn": 15,
...
--------- | ------- | ------- | ------- | -----------
    `first_name` | string |  required  | question-id-536
        ...
        `tests.*.type` | integer |  required  | 0:ACT 1:SAT (before March 2016) 9:SAT (March 2016 or after) 2:SAT Subject Tests 3:AP Subject Tests 4:IB Subject Tests 5:TOEFL iBT 6:TOEFL Paper 8:PTE Academic Tests 7:IELTS
        `tests.*.subject` | integer |  required  | 24-29 is available if 0"(ACT) is set as 'tests.*.type'/24, 27 or 28 if "1"(SAT before March 2016) is set as 'tests.*.type'/24, 27, 30 or 31 if "9"(SAT March 2016 or after) is set as 'tests.*.type'/0-24 is available if "2"(SAT Subject Tests) is set as 'tests.*.type', 32-74 is available for 'tests.*.subject' if "3"(AP Subject Tests) is set as 'tests.*.type',
        `tests.*.score` | integer |  optional  | optional, but required if "3"(AP Subject Tests) is NOT set as 'tests.*.type'. The min number is 1 and the max number is 5 if "3"(AP Subject Tests) is set as tests.*.type'
        `tests.*.taken_date` | date |  required  | e.g."11/27/2020"
        `tests.*.future_sitting_months` | array |  optional  | The min length of 'future_act_sitting_months' is 0 and the max length is 3, noticed that the value should be in between of January 2020 and December 2021 and in "month year" format if "0"(ACT) or "9"(SAT March 2016 or after) is set as 'tests.*.type', e.g.["06/2021", "07/2021"]
